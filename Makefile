...
AUTOHEADER = ${SHELL} /github/xz/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /github/xz/build-aux/missing automake-1.16
AWK = gawk
CAPSICUM_LIB = 
CC = gcc
CCAS = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /github/xz/build-aux/missing makeinfo
MANIFEST_TOOL = :
...
abs_builddir = /github/xz
abs_srcdir = /github/xz
abs_top_builddir = /github/xz
abs_top_srcdir = /github/xz
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /github/xz/build-aux/install-sh
